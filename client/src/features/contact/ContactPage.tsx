...
export default function ContactPage() {
  //const data = useSelector((state: CounterState) => state.data); //Read data from store, a global state!
  const {data} = useAppSelector(state => state.counter); //Need curly bracket to extract only data property from object!
