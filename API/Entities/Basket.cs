...
public class Basket
{
    ...
    public void AddItem(Product product, int quantity)
    {
        ...
        {
            existingItem.Quantity += quantity; // Same as a = a + b
        }
    }
    ...
    {
        return Items.FirstOrDefault(item => item.ProductId == productId); //FirstOrDefault return first matching item or null if no match
    }
}
